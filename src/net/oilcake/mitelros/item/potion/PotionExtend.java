...
public class PotionExtend extends MobEffectList{
    ...
    public static final MobEffectList freeze = new PotionExtend(getNextPotionID(), true, 65535).setIconIndex(4,2).setPotionName("potion.extend.freeze").func_111184_a(GenericAttributes.movementSpeed, "7107DE5E-7CE8-4030-940E-514C1F160890", -0.4, 2);
    ...
    public static final MobEffectList heat_stroke = new PotionExtend(getNextPotionID(), true, 11141120).setIconIndex(6,2).setPotionName("potion.extend.heatstroke");
