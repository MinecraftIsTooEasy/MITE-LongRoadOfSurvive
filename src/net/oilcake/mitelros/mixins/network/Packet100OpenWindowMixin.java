...
public class Packet100OpenWindowMixin {
    ...
    public void handleOpenWindow(ClientPlayer player) {
        ...
        //System.out.println("type"+ this.inventoryType);
        ...
        if (this.inventoryType == 0) {
            ...
            if (this.inventoryType == 9) {
                ...
                player.displayGUIEnchantReserver(this.x, this.y, this.z, new EnchantReserverSlots(new InventorySubcontainer(this.windowTitle, this.useProvidedWindowTitle, this.slotsCount)));
                player.openContainer.windowId = this.windowId;
            } else {
