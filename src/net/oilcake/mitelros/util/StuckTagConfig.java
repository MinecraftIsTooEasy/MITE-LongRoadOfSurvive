...
public class StuckTagConfig {
    ...
    public static class TagConfig {
        ...
        public static ConfigItem <Boolean> TagBattleSufferLVL1 = new ConfigItem<>("BattleSufferLVL1",false,"(LVL2)久经沙场：主世界矿洞生成骷髅侍卫的概率提升");
        ...
        public static ConfigItem <Boolean> TagBattleSufferLVL2 = new ConfigItem<>("BattleSufferLVL2",false,"(LVL3)久经沙场：主世界矿洞生成骷髅侍卫的概率提升，骷髅领主的生命值提升50%，攻击力提升40%，召唤的支援获得强化");
