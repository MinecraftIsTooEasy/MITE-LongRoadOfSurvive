...
public class AchievementExtend {
    ...
    public static void registerAchievements() {
        ...
        getWitherSkull = (new Achievement(getNextAchievementID(), "getWitherSkull", 4, 11, new ItemStack(Block.skull, 1, 1), AchievementList.portalToNether)).setSpecial().registerAchievement();
