...
public class WorldProviderUnderworldMixin extends WorldProvider {
   ...
   public void registerWorldChunkManager() {
      this.worldChunkMgr = new WorldChunkManagerHell((Boolean)StuckTagConfig.TagConfig.TagDeadgeothermy.ConfigValue ? BiomeBases.underworldinfreeze : BiomeGenBase.underworld, 1.0F, 0.0F);
   }
}
