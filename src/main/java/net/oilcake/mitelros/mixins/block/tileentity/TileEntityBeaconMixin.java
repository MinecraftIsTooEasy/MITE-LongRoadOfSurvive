...
public abstract class TileEntityBeaconMixin extends TileEntity {
   ...
   public boolean isItemValidForSlot(int par1, ItemStack par2ItemStack) {
      return par2ItemStack.itemID == Item.emerald.itemID || par2ItemStack.itemID == Item.diamond.itemID || par2ItemStack.itemID == Item.ingotGold.itemID || par2ItemStack.itemID == Item.ingotIron.itemID || par2ItemStack.itemID == Item.ingotMithril.itemID || par2ItemStack.itemID == Item.ingotAdamantium.itemID || par2ItemStack.itemID == Item.ingotAncientMetal.itemID || par2ItemStack.itemID == Item.ingotCopper.itemID || par2ItemStack.itemID == Item.ingotSilver.itemID || par2ItemStack.itemID == Items.nickelIngot.itemID || par2ItemStack.itemID == Items.tungstenIngot.itemID || par2ItemStack.itemID == Items.UruIngot.itemID;
   }
}
