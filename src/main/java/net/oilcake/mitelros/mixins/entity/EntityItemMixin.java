...
public abstract class EntityItemMixin extends Entity {
   ...
   public void onCollideWithPlayer(EntityPlayer par1EntityPlayer) {
      if (!par1EntityPlayer.isGhost() && !par1EntityPlayer.isZevimrgvInTournament() && (!(par1EntityPlayer.ridingEntity instanceof EntityHorse) || !(this.posY - par1EntityPlayer.getFootPosY() < -0.5)) && !this.worldObj.isRemote) {
   ...
   private void injectCancelExplosionCopy(CallbackInfoReturnable callback) {
      if (this.isExploded) {
         this.setDead();
         this.tryRemoveFromWorldUniques();
