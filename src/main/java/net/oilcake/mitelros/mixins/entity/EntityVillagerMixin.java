   ...
   private void addDefaultEquipmentAndRecipies(int par1) {
      ...
      switch (this.getProfession()) {
         case 1:
            ...
            if (this.rand.nextFloat() < this.adjustProbability(0.25F)) {
               var2.add(new MerchantRecipe(new ItemStack(Item.potato, 14 + this.rand.nextInt(3)), new ItemStack(Item.emerald.itemID, 1, 0)));
            }
            ...
            if (this.rand.nextFloat() < this.adjustProbability(0.25F)) {
               var2.add(new MerchantRecipe(new ItemStack(Items.beetroot, 14 + this.rand.nextInt(3)), new ItemStack(Item.emerald.itemID, 1, 0)));
            }

            if (this.rand.nextFloat() < this.adjustProbability(0.4F)) {
               var2.add(new MerchantRecipe(new ItemStack(Item.chickenRaw, 10 + this.rand.nextInt(3)), new ItemStack(Item.emerald.itemID, 1, 0)));
            }
         ...
         case 4:
            ...
            if (this.rand.nextFloat() < this.adjustProbability(0.5F)) {
               var2.add(new MerchantRecipe(new ItemStack(Item.dough, 4 + this.rand.nextInt(2)), new ItemStack(Item.emerald.itemID, 1, 0)));
            }
         ...
         case 6:
            ...
            if (this.rand.nextFloat() < this.adjustProbability(0.2F)) {
               var2.add(new MerchantRecipe(new ItemStack(Item.wormRaw, 14 + this.rand.nextInt(2)), new ItemStack(Item.emerald, 1, 0)));
            }

            if (this.rand.nextFloat() < this.adjustProbability(0.5F)) {
               var2.add(new MerchantRecipe(new ItemStack(Item.fishRaw, 14 + this.rand.nextInt(3)), new ItemStack(Item.emerald.itemID, 1, 0)));
            }
            ...
            if (this.rand.nextFloat() < this.adjustProbability(0.3F)) {
               var2.add(new MerchantRecipe(new ItemStack(Item.fishLargeRaw, 12 + this.rand.nextInt(2)), new ItemStack(Item.emerald.itemID, 1, 0)));
            }
