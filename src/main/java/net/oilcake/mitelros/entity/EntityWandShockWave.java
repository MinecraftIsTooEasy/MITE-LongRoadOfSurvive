...
public class EntityWandShockWave extends EntityThrowable {
   ...
   public void onUpdate() {
      super.onUpdate();
      this.worldObj.spawnParticle(EnumParticle.magicCrit, this.posX, this.posY, this.posZ, 0.0, 0.0, 0.0);
      this.worldObj.spawnParticle(EnumParticle.witchMagic, this.posX, this.posY, this.posZ, 0.0, 0.0, 0.0);
   ...
   protected void onImpact(RaycastCollision rc) {
      if (!this.worldObj.isRemote) {
         ...
         if (rc.isEntity() && rc.getEntityHit() instanceof EntityLivingBase) {
            ...
            EntityLightningBolt lightingbolt = new EntityLightningBolt(this.worldObj, (double)rc.block_hit_x, (double)rc.block_hit_y, (double)rc.block_hit_z);
            this.worldObj.spawnEntityInWorld(lightingbolt);
            lightingbolt.entityFX(EnumEntityFX.summoned);
