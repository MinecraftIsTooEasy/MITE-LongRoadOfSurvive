...
public class WorldGenUnderworldCastle extends WorldGenerator {
   ...
   private static final WeightedRandomChestContent[] chest_contents_for_underworld_castle;
                  ...
                  if (!par1World.isUnderworld() && var6 != Block.stone.blockID) {
                     ...
                     if (!par1World.isUnderworld() && var6 != 0) {
                        ...
                        if (!par1World.isUnderworld() && var6 != Block.stone.blockID) {
                           ...
                           int par0;
                           for(par0 = -25; par0 <= 25; ++par0) {
                              for(int par2 = -25; par2 <= 25; ++par2) {
                                 par1World.setBlock(x + par0, y, z + par2, this.getRandomStone(random.nextInt(3)), 0, 2);
                              }
                           }

                           for(par0 = 0; par0 < 22; ++par0) {
                              ++y;
                              int Builder = 0;
                              ...
                              int par2;
                              char id;
                              for(par1 = 25; par1 >= 0; --par1) {
                                 for(par2 = 25; par2 >= -25; --par2) {
                                    id = Layer[par0].charAt(Builder);
                                    if (id != ' ') {
                                       par1World.setBlock(x + par2, y, z + par1, this.getRandomStone(random.nextInt(3)), 0, 2);
                                    } else {
                           ...
                           y -= 21;
                           this.fillBlocksWithMetadata(par1World, x + 19, x + 19, y, y, z - 2, z + 2, Block.stairsCobblestone.blockID, 1);
                           this.fillBlocksWithMetadata(par1World, x - 2, x + 2, y, y, z - 19, z - 19, Block.stairsCobblestone.blockID, 2);
                           this.fillBlocksWithMetadata(par1World, x - 19, x - 19, y, y, z - 2, z + 2, Block.stairsCobblestone.blockID, 0);
                           this.fillBlocksWithMetadata(par1World, x - 2, x + 2, y, y, z + 19, z + 19, Block.stairsCobblestone.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 3, x + 3, y, y, z - 14, z + 14, Block.cloth.blockID, 8);
                           this.fillBlocksWithMetadata(par1World, x - 14, x + 14, y, y, z - 3, z + 3, Block.cloth.blockID, 8);
                           this.fillBlocksWithMetadata(par1World, x - 2, x + 2, y, y, z - 14, z + 14, Block.cloth.blockID, 9);
                           this.fillBlocksWithMetadata(par1World, x - 14, x + 14, y, y, z - 2, z + 2, Block.cloth.blockID, 9);
                           this.fillBlocksWithMetadata(par1World, x - 2, x + 2, y, y, z - 2, z + 2, Block.cloth.blockID, 3);
                           ++y;
                           ...
                           par1World.setBlock(x - 8, y, z - 5, Block.chestAncientMetal.blockID, Block.chestAncientMetal.getMetadataForDirectionFacing(0, this.getRandomDirection(random)), 2);
                           ...
                           if (var17 != null) {
                              WeightedRandomChestContent.generateChestContents(par1World, y, random, var16, var17, 8, (float[])null);
                           }
                           ...
                           this.fillBlocksWithMetadata(par1World, x - 14, x - 10, y, y, z - 5, z - 5, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 10, x + 14, y, y, z + 5, z + 5, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 14, x - 10, y, y, z - 6, z - 6, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 10, x + 14, y, y, z + 6, z + 6, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 14, x + 15, y, y, z + 20, z + 20, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 20, x + 20, y, y, z + 14, z + 15, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 14, x - 15, y, y, z - 20, z - 20, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 20, x - 20, y, y, z - 14, z - 15, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 14, x + 15, y, y, z - 20, z - 20, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 20, x + 20, y, y, z - 14, z - 15, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 14, x - 15, y, y, z + 20, z + 20, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 20, x - 20, y, y, z + 14, z + 15, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 14, x + 15, y, y, z + 21, z + 21, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 21, x + 21, y, y, z + 14, z + 15, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 14, x - 15, y, y, z - 21, z - 21, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 21, x - 21, y, y, z - 14, z - 15, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 14, x + 15, y, y, z - 21, z - 21, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 21, x + 21, y, y, z - 14, z - 15, Block.stoneSingleSlab.blockID, 11);
                           ...
                           this.fillBlocksWithMetadata(par1World, x - 21, x - 21, y, y, z + 14, z + 15, Block.stoneSingleSlab.blockID, 11);
                           ++y;
                           this.fillBlocksWithMetadata(par1World, x - 4, x - 5, y, y, z - 4, z - 4, Block.stairsCobblestone.blockID, 3);
                           par1World.setBlock(x - 4, y, z - 5, Block.stairsCobblestone.blockID, 1, 2);
                           this.fillBlocksWithMetadata(par1World, x + 4, x + 5, y, y, z + 4, z + 4, Block.stairsCobblestone.blockID, 2);
                           ...
                           this.fillBlocksWithMetadata(par1World, x - 10, x - 12, y, y, z - 7, z - 7, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 10, x - 12, y, y, z - 8, z - 8, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 10, x + 12, y, y, z + 7, z + 7, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 10, x + 12, y, y, z + 8, z + 8, Block.stoneSingleSlab.blockID, 11);
                           ...
                           par1World.setBlock(x - 4, y, z - 4, Block.cobblestoneWall.blockID);
                           this.fillBlocksWithMetadata(par1World, x - 13, x - 12, y, y, z + 5, z + 5, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 13, x - 12, y, y, z + 6, z + 6, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 12, x + 13, y, y, z - 5, z - 5, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 12, x + 13, y, y, z - 6, z - 6, Block.stoneSingleSlab.blockID, 11);
                           ...
                           par1World.setBlock(x - 11, y, z - 9, Block.stoneSingleSlab.blockID, 3, 2);
                           par1World.setBlock(x - 10, y, z - 10, Block.stoneSingleSlab.blockID, 11, 2);
                           this.fillBlocksWithMetadata(par1World, x + 23, x + 24, y, y, z + 17, z + 17, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 17, x + 17, y, y, z + 23, z + 24, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 24, x - 23, y, y, z - 17, z - 17, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 17, x - 17, y, y, z - 24, z - 23, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 24, x - 23, y, y, z + 17, z + 17, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 17, x - 17, y, y, z + 23, z + 24, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 23, x + 24, y, y, z - 17, z - 17, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 17, x + 17, y, y, z - 24, z - 23, Block.stoneSingleSlab.blockID, 11);
                           ...
                           this.fillBlocksWithMetadata(par1World, x + 8, x + 8, y, y, z + 10, z + 12, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 9, x + 9, y, y, z + 10, z + 11, Block.stoneSingleSlab.blockID, 3);
                           par1World.setBlock(x - 3, y, z + 6, Block.cobblestoneWall.blockID);
                           par1World.setBlock(x - 3, y, z + 8, Block.cobblestoneWall.blockID);
                           par1World.setBlock(x - 3, y, z + 10, Block.cobblestoneWall.blockID);
                           par1World.setBlock(x - 3, y, z + 12, Block.cobblestoneWall.blockID);
                           ...
                           this.fillBlocksWithMetadata(par1World, x - 11, x - 12, y, y, z + 8, z + 8, Block.stoneSingleSlab.blockID, 11);
                           ...
                           par1World.setBlock(x + 12, y, z - 7, Block.stoneSingleSlab.blockID, 3, 2);
                           this.fillBlocksWithMetadata(par1World, x + 11, x + 12, y, y, z - 8, z - 8, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 23, x + 24, y, y, z + 19, z + 19, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 23, x + 24, y, y, z + 18, z + 18, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 19, x + 19, y, y, z + 23, z + 24, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 18, x + 18, y, y, z + 23, z + 24, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 24, x - 23, y, y, z - 19, z - 19, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 24, x - 23, y, y, z - 18, z - 18, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 19, x - 19, y, y, z - 24, z - 23, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 18, x - 18, y, y, z - 24, z - 23, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 23, x + 24, y, y, z - 19, z - 19, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 23, x + 24, y, y, z - 18, z - 18, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 19, x + 19, y, y, z - 24, z - 23, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 18, x + 18, y, y, z - 24, z - 23, Block.stoneSingleSlab.blockID, 3);
                           ...
                           this.fillBlocksWithMetadata(par1World, x + 6, x + 6, y, y, z + 10, z + 13, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 7, x + 7, y, y, z + 10, z + 12, Block.stoneSingleSlab.blockID, 3);
                           par1World.setBlock(x - 3, y, z + 6, Block.torchWood.blockID, 5, 2);
                           par1World.setBlock(x - 3, y, z + 8, Block.torchWood.blockID, 5, 2);
                           par1World.setBlock(x - 3, y, z + 10, Block.torchWood.blockID, 5, 2);
                           par1World.setBlock(x - 3, y, z + 12, Block.torchWood.blockID, 5, 2);
                           ...
                           this.fillBlocksWithMetadata(par1World, x - 10, x - 11, y, y, z + 9, z + 9, Block.stoneSingleSlab.blockID, 3);
                           par1World.setBlock(x - 10, y, z + 10, Block.stoneSingleSlab.blockID, 11, 2);
                           par1World.setBlock(x - 4, y, z - 4, Block.cobblestoneWall.blockID);
                           par1World.setBlock(x - 6, y, z - 3, Block.torchWood.blockID, 5, 2);
                           par1World.setBlock(x - 8, y, z - 3, Block.torchWood.blockID, 5, 2);
                           ...
                           this.fillBlocksWithMetadata(par1World, x + 10, x + 11, y, y, z - 9, z - 9, Block.stoneSingleSlab.blockID, 3);
                           par1World.setBlock(x + 10, y, z - 10, Block.stoneSingleSlab.blockID, 11, 2);
                           this.fillBlocksWithMetadata(par1World, x + 21, x + 21, y, y, z + 23, z + 24, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 20, x + 20, y, y, z + 23, z + 24, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 23, x + 24, y, y, z + 20, z + 20, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 23, x + 24, y, y, z + 21, z + 21, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 21, x - 21, y, y, z - 24, z - 23, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 20, x - 20, y, y, z - 24, z - 23, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 24, x - 23, y, y, z - 20, z - 20, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 24, x - 23, y, y, z - 21, z - 21, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 21, x - 21, y, y, z + 23, z + 24, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 20, x - 20, y, y, z + 23, z + 24, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 24, x - 23, y, y, z + 20, z + 20, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 24, x - 23, y, y, z + 21, z + 21, Block.stoneSingleSlab.blockID, 3);
                           ...
                           this.fillBlocksWithMetadata(par1World, x + 5, x + 5, y, y, z + 10, z + 13, Block.stoneSingleSlab.blockID, 3);
                           ...
                           this.fillBlocksWithMetadata(par1World, x - 9, x - 9, y, y, z + 10, z + 11, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 8, x - 8, y, y, z + 11, z + 12, Block.stoneSingleSlab.blockID, 11);
                           par1World.setBlock(x - 23, y, z + 23, Block.stoneSingleSlab.blockID, 11, 2);
                           par1World.setBlock(x - 22, y, z + 23, Block.stoneSingleSlab.blockID, 3, 2);
                           par1World.setBlock(x - 23, y, z + 22, Block.stoneSingleSlab.blockID, 3, 2);
                           ...
                           par1World.setBlock(x - 22, y, z - 21, Block.stoneSingleSlab.blockID, 3, 2);
                           par1World.setBlock(x - 21, y, z - 22, Block.stoneSingleSlab.blockID, 3, 2);
                           this.fillBlocksWithMetadata(par1World, x + 2, x + 2, y, y, z + 10, z + 14, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 3, x + 3, y, y, z + 10, z + 14, Block.stoneSingleSlab.blockID, 3);
                           par1World.setBlock(x + 7, y, z + 8, Block.stairsCobblestone.blockID, 1, 2);
                           this.fillBlocksWithMetadata(par1World, x - 6, x - 6, y, y, z + 12, z + 13, Block.stoneSingleSlab.blockID, 11);
                           ...
                           this.fillBlocksWithMetadata(par1World, x + 1, x + 1, y, y, z + 10, z + 14, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x, x - 3, y, y, z + 10, z + 14, Block.stoneSingleSlab.blockID, 11);
                           ...
                           var11.setLocationAndAngles((double)x + 0.5, (double)y + 2.0, (double)z + 0.5, 0.0F, 0.0F);
                           ...
                           par1World.setBlock(x + 13, y, z, Block.chestAncientMetal.blockID, Block.chestAncientMetal.getMetadataForDirectionFacing(0, this.getRandomDirection(random)), 2);
                           ...
                           this.fillBlocksWithMetadata(par1World, x + 7, x + 7, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 8, x + 8, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 7, x - 7, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 8, x - 8, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 7, x + 7, y, y, z - 2, z - 3, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 8, x + 8, y, y, z - 2, z - 3, Block.stoneSingleSlab.blockID, 11);
                           ...
                           this.fillBlocksWithMetadata(par1World, x - 8, x - 8, y, y, z - 2, z - 3, Block.stoneSingleSlab.blockID, 11);
                           ++y;
                           this.fillBlocksWithMetadata(par1World, x + 9, x + 9, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 10, x + 10, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 9, x - 9, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 10, x - 10, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 9, x + 9, y, y, z - 2, z - 3, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 10, x + 10, y, y, z - 2, z - 3, Block.stoneSingleSlab.blockID, 11);
                           ...
                           ++y;
                           this.fillBlocksWithMetadata(par1World, x + 11, x + 11, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 12, x + 12, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 11, x - 11, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 12, x - 12, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 11, x + 11, y, y, z - 2, z - 3, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 12, x + 12, y, y, z - 2, z - 3, Block.stoneSingleSlab.blockID, 11);
                           ...
                           par1World.setBlock(x + 13, y, z - 19, Block.stairsCobblestone.blockID, 1, 2);
                           ++y;
                           this.fillBlocksWithMetadata(par1World, x + 13, x + 13, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 14, x + 14, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x - 13, x - 13, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x - 14, x - 14, y, y, z + 2, z + 3, Block.stoneSingleSlab.blockID, 11);
                           this.fillBlocksWithMetadata(par1World, x + 13, x + 13, y, y, z - 2, z - 3, Block.stoneSingleSlab.blockID, 3);
                           this.fillBlocksWithMetadata(par1World, x + 14, x + 14, y, y, z - 2, z - 3, Block.stoneSingleSlab.blockID, 11);
   ...
   private int getFlitteredBlockID(char index) {
      if (index == 'S') {
         ...
         return index == 'F' ? this.getRandomFence() : 0;
      }
   }
   ...
   static {
      ...
      chest_contents_for_underworld_castle = new WeightedRandomChestContent[]{new WeightedRandomChestContent(Item.ingotAncientMetal.itemID, 0, 3, 5, 10), new WeightedRandomChestContent(Item.ingotGold.itemID, 0, 3, 5, 10), new WeightedRandomChestContent(Item.diamond.itemID, 0, 2, 4, 10), new WeightedRandomChestContent(Items.AncientmetalArmorPiece.itemID, 0, 6, 9, 20), new WeightedRandomChestContent(Item.coinAncientMetal.itemID, 0, 2, 4, 15), new WeightedRandomChestContent(Item.horseArmorMithril.itemID, 0, 1, 1, 2), new WeightedRandomChestContent(Item.horseArmorAncientMetal.itemID, 0, 1, 1, 2), new WeightedRandomChestContent(Items.FreezeWand.itemID, 0, 1, 1, 2), new WeightedRandomChestContent(Items.LavaWand.itemID, 0, 1, 1, 2), new WeightedRandomChestContent(Item.warHammerAncientMetal.itemID, 0, 1, 1, 2), new WeightedRandomChestContent(Item.battleAxeAncientMetal.itemID, 0, 1, 1, 2), new WeightedRandomChestContent(Item.swordAncientMetal.itemID, 0, 1, 1, 2), new WeightedRandomChestContent(Item.bootsAncientMetal.itemID, 0, 1, 1, 2), new WeightedRandomChestContent(Item.legsAncientMetal.itemID, 0, 1, 1, 2), new WeightedRandomChestContent(Item.plateAncientMetal.itemID, 0, 1, 1, 2), new WeightedRandomChestContent(Item.helmetAncientMetal.itemID, 0, 1, 1, 2), new WeightedRandomChestContent(Items.ChestplateAncientmetalsacred.itemID, 0, 1, 1, 1), new WeightedRandomChestContent(Items.HelmetAncientmetalsacred.itemID, 0, 1, 1, 1), new WeightedRandomChestContent(Items.BootsAncientmetalsacred.itemID, 0, 1, 1, 1), new WeightedRandomChestContent(Items.LeggingsAncientmetalsacred.itemID, 0, 1, 1, 1), new WeightedRandomChestContent(Items.Goldenapplelegend.itemID, 0, 1, 1, 1)};
   }
}
